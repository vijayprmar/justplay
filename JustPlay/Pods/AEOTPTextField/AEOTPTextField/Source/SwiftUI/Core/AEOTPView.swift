...
public struct AEOTPView: View {
    ...
    public init(
        ...
        otpBackgroundColor: UIColor = UIColor(red: 1, green: 1, blue: 1, alpha: 0.1),
        otpFilledBackgroundColor: UIColor = UIColor(red: 1, green: 1, blue: 1, alpha: 0.1),
        otpCornerRaduis: CGFloat = 10,
        otpDefaultBorderColor: UIColor = .clear,
        otpFilledBorderColor: UIColor = .white,
        otpDefaultBorderWidth: CGFloat = 1,
        otpFilledBorderWidth: CGFloat = 1,
        otpTextColor: UIColor = .white,
        otpFontSize: CGFloat = 22,
        otpFont: UIFont = UIFont.systemFont(ofSize: 22, weight: .bold),
